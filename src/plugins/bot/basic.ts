...
export const commands: PluginCommand[] = [
  ...
  },
  {
    ...
    category: 'Bot',
    handler: async ({ message, db }) => {
      const { daily } = await import('../../../lib/game.cjs');
      daily(message, db);
    },
  },
  {
    ...
    handler: async ({ message, args, db }) => {
      const { transfer } = await import('../../../lib/game.cjs');
  ...
  },
  {
    ...
    category: 'Bot',
    handler: async ({ message, args, db }) => {
      const { buy } = await import('../../../lib/game.cjs');
      buy(message, args, db);
    },
  },
  {
  ...
  },
  {
    ...
    handler: async ({ message, args, db, socket }) => {
      const { runtime } = await import('../../../lib/function.cjs');
  ...
  },
  {
    ...
    category: 'Bot',
    handler: async ({ message }) => {
      const { runtime, formatp } = await import('../../../lib/function.cjs');
